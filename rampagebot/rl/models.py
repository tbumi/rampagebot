...
class Observation(BaseModel):
    ...
    pct_health_of_enemy_hero_1: float = Field(ge=0, le=1)
    pct_health_of_enemy_hero_2: float = Field(ge=0, le=1)
    pct_health_of_enemy_hero_3: float = Field(ge=0, le=1)
    pct_health_of_enemy_hero_4: float = Field(ge=0, le=1)
    pct_health_of_enemy_hero_5: float = Field(ge=0, le=1)
    ...
    pct_health_of_enemy_tower_t1top: float = Field(ge=0, le=1)
    pct_health_of_enemy_tower_t1mid: float = Field(ge=0, le=1)
    pct_health_of_enemy_tower_t1bot: float = Field(ge=0, le=1)
    pct_health_of_enemy_tower_t2top: float = Field(ge=0, le=1)
    pct_health_of_enemy_tower_t2mid: float = Field(ge=0, le=1)
    pct_health_of_enemy_tower_t2bot: float = Field(ge=0, le=1)
    pct_health_of_enemy_tower_t3top: float = Field(ge=0, le=1)
    pct_health_of_enemy_tower_t3mid: float = Field(ge=0, le=1)
    pct_health_of_enemy_tower_t3bot: float = Field(ge=0, le=1)
    pct_health_of_enemy_tower_t4top: float = Field(ge=0, le=1)
    pct_health_of_enemy_tower_t4bot: float = Field(ge=0, le=1)
